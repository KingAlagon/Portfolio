...
function Skills() {
    ...
    return (
        <div id="skills" className="p-8 md:p-20 bg-gray-900 text-white py-12 px-4 min-h-screen flex flex-col items-center justify-center">
            {/* Section Header */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div className="bg-gray-800 p-6 rounded-lg shadow-lg" data-aos="fade-right">
                    ...
                    <ul className="space-y-3">
                        ...
                        <li className="flex items-center">
                            <span className="w-2/3">Javascript</span>
                            <div className="w-1/3 bg-gray-700 rounded-full overflow-hidden">
                                <div className="h-2 bg-yellow-500" style={{ width: "75%" }}></div>
                            </div>
                        </li>
                ...
                <div className="bg-gray-800 p-6 rounded-lg shadow-lg" data-aos="fade-left">
                ...
                {/* Tools & Technologies */}
                <div className="bg-gray-800 p-6 rounded-lg shadow-lg" data-aos="zoom-in">
