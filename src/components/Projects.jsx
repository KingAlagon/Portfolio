            ...
            <div id="projects" className="bg-gray-800 py-12 px-4 min-h-screen flex flex-col items-center justify-center">
                ...
                <div className="py-12 px-4 grid gap-8 grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div data-aos="fade-right" data-aos-once="true" data-aos-duration="1000" className="relative">
                        <a href="https://github.com/KingAlagon/STOCKLOGIX" target="_blank" className="relative flex flex-col items-center text-center bg-gray-900 rounded-lg p-6 shadow-lg group transition-transform duration-300 hover:scale-110">
                    ...
                    <div data-aos="fade-left" data-aos-once="true" className="relative">
                        <a href="https://github.com/KingAlagon/Hangramming.git" target="_blank" rel="noopener noreferrer" className="relative flex flex-col items-center text-center bg-gray-900 rounded-lg p-6 shadow-lg group transition-transform duration-300 hover:scale-110">
                    ...
                    <div data-aos="zoom-in" data-aos-once="true" className="relative">
                        <a href="https://klan3d.com" target="_blank" rel="noopener noreferrer" className="relative flex flex-col items-center text-center bg-gray-900 rounded-lg p-6 shadow-lg group transition-transform duration-300 hover:scale-110">
                    ...
                    {/* Project Card 4 */}
                    <div data-aos="zoom-in" data-aos-once="true" className="relative">
                        <a href="https://running-man-game-construct-2.vercel.app/" target="_blank" rel="noopener noreferrer" className="relative flex flex-col items-center text-center bg-gray-900 rounded-lg p-6 shadow-lg group transition-transform duration-300 hover:scale-110">
                    ...
                    <div data-aos="fade-right" data-aos-once="true" className="relative">
                        <a href="https://github.com/KingAlagon/Phonebook" target="_blank" rel="noopener noreferrer" className="relative flex flex-col items-center text-center bg-gray-900 rounded-lg p-6 shadow-lg group transition-transform duration-300 hover:scale-110">
                    ...
                    <div data-aos="fade-left" data-aos-once="true" className="relative">
                        <div
                            className="relative flex flex-col items-center text-center bg-gray-900 rounded-lg p-6 shadow-lg group transition-transform duration-300 hover:scale-110 cursor-pointer" onClick={() => setIsModalOpen(true)}>
