...
function Header() {
    return (
        <header className="flex flex-col md:flex-row justify-between items-center py-20 px-4 md:px-20 lg:px-40 text-white">
            <a href="/" className="text-xl md:text-2xl font-bold text-yellow-100">My Portfolio</a>
            <nav className="mt-4 md:mt-0 w-full md:w-auto flex flex-col md:flex-row md:items-center">
                <ul className="flex flex-col md:flex-row space-y-2 md:space-y-0 sm:space-x-6 md:space-x-8 text-center text-xl">
                    <li><Link to="header" smooth={true} duration={500} className="text-yellow-500 cursor-pointer">Home</Link></li>
                    <li><Link to="experience" smooth={true} duration={500} className="text-yellow-500 cursor-pointer">Experience</Link></li>
                    <li><Link to="projects" smooth={true} duration={1000} className="text-yellow-500 cursor-pointer">Projects</Link></li>
                    <li><Link to="skills" smooth={true} duration={1300} className="text-yellow-500 cursor-pointer">Skills</Link></li>
                    <li><Link to="contact" smooth={true} duration={1500} className="md:border-r-2 sm:border-r-0 pr-3 text-yellow-500 cursor-pointer">Contact</Link></li>
                </ul>
                <ul className="flex flex-wrap justify-center items-center space-x-1 mt-4 md:mt-0 md:ml-4">
